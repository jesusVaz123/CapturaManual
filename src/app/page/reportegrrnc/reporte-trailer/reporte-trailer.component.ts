...
@Component({
  selector: 'app-reporte-trailer',
  templateUrl: './reporte-trailer.component.html',
  styleUrls: ['./reporte-trailer.component.css']
})
export class ReporteTrailerComponent implements OnInit {
