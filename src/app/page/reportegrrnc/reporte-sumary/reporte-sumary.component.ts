...
@Component({
  selector: 'app-reporte-sumary',
  templateUrl: './reporte-sumary.component.html',
  styleUrls: ['./reporte-sumary.component.css']
})
export class ReporteSumaryComponent implements OnInit {
 Busqueda:any;
    constructor(private formBuilder: FormBuilder, private router: Router, 
        private datePipe: DatePipe, private AquirerService: AquirerService) { }
    displayedColumns: string[] = ['idcom', 'tipocuenta', 'numpago', 'fechapago','monpago','refpago',
    'montonetopago','montobruto','montodesc','montoservicio','montoajuste','montoimpuesto',
    'montosaldodebito','numdepositodirecto','cuentabancaria','cuentabancariainter','codigobanco'];
