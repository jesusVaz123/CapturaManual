...
@Component({
  selector: 'app-reporte-submission',
  templateUrl: './reporte-submission.component.html',
  styleUrls: ['./reporte-submission.component.css']
})
export class ReporteSubmissionComponent implements OnInit {
